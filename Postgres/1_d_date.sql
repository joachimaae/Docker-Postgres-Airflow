-- From https://medium.com/@duffn/creating-a-date-dimension-table-in-postgresql-af3f8e2941ac
...
SELECT TO_CHAR(datum,'yyyymmdd')::INT AS date_dim_id,
       ...
       CASE
         ...
         ELSE FALSE
       END AS weekend_indr
FROM (SELECT '2005-01-01'::DATE+ SEQUENCE.DAY AS datum -- Fra 01.0.1.2005 til 31.12.2040
